...
export default {
  ...
  methods:{
    ...
    dealHeadColumn(){
      ...
      console.log(this.headerColumnsDealAfter)
    },
    async initData(){
    ...
    async dealApiRequest(params={}){
      ...
      console.log('this.tableConf',this.tableConf)
        //search reference
        this.tableConf.searchBtns.forEach(c=>{
          ...
          if(this.tableConf.initSuccessCallback){
            ...
            if(this.tableConf.initMappingObj){
              ...
              console.log('_',_)
              console.log('_[this.tableConf.initMappingObj.list]', _[this.tableConf.initMappingObj.list])
              this.loading = false;
              this.totalCount=_.pager.totalCount
